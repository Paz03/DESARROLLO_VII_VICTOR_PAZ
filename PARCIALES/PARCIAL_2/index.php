...
switch ($action) {
    case 'add':
        if (isset($_GET['titulo']) && isset($_GET['autor']) && isset($_GET['anioPublicacion']) && isset($_GET['estado']) && isset($_GET['fechaAdquisicion']) && isset($_GET['tipo'])) {
            ...
            $gestorRecursos->agregarRecurso($recursoNueva);
            $mensaje = "Recurso agregada exitosamente.";
        }
        break;
    ...
    case 'edit':
        if (isset($_GET['id']) && isset($_GET['titulo']) && isset($_GET['autor']) && isset($_GET['anioPublicacion']) && isset($_GET['estado']) && isset($_GET['fechaAdquisicion']) && isset($_GET['tipo'])) {
            ...
            $gestorRecursos->actualizarRecurso($RecursoEnEdicion);
                $mensaje = "Recurso actualizada exitosamente.";
        }
        break;
    ...
    case 'delete':
        if (isset($_GET['id'])) {
            ...
            $gestorRecursos->eliminarRecurso($_GET['id']);
            $mensaje = "Recurso eliminada exitosamente.";
        }
        break;
    ...
    case 'status':
        if (isset($_GET['id']) && isset($_GET['estado'])) {
            ...
            $gestorRecursos->cambiarEstadoTarea($_GET['id'], $_GET['estado']);
            $mensaje = "Estado de la Recurso cambiado a " . $estadosLegibles[$_GET['estado']] . ".";
        }
        break;
    ...
    case 'filter':
        if (isset($_GET['filterEstado'])) {
            ...
            $filterEstado = $_GET['filterEstado'];
            $tareas = $gestorRecursos->filtras($filterEstado);
        }
        break;
    ...
    default:
        ...
        $tareas = $gestorTareas->cargarRecursos();
        break;
}
?>
<!DOCTYPE html>
