...
// Tu código aquí
echo "</br>";
function ListaTutoria($estudiantes){
    echo "Necesita tutoria: <br>";
    foreach ($estudiantes as &$estudiante){
        $promedio = calcularPromedio($estudiante["calificaciones"]);
        $estudiante["promedio"] = $promedio;
        if ($promedio<75){
...
function ListaHonor($estudiantes){
    echo "lista de Honor: <br>";
    foreach ($estudiantes as &$estudiante){
        $promedio = calcularPromedio($estudiante["calificaciones"]);
        $estudiante["promedio"] = $promedio;
        if ($promedio>=90){
...
ListaHonor($estudiantes);
ListaTutoria($estudiantes)
?>
